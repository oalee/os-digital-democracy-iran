...
\subsection{Civic Technology and Democracy}

Civic technology, or civic tech, encompasses the use of technology to strengthen the relationship between citizens and their governments, encourage public participation, and promote democratic processes \cite{zhang2022review}. This involves the creation of digital platforms, tools, and applications that empower citizens to express their opinions, engage in decision-making, and hold governments accountable \cite{zhang2022review}. Examples of civic technology include online platforms for policy deliberation, participatory budgeting, and crowdsourcing solutions to local problems \cite{zhang2022review,tseng2022rethinking}.

As stated by Dr. Tsai Ing-Wen, the former President of Taiwan, the objective is to "build a unified democracy, not hijacked by ideologies; an efficient democracy that responds to the demands of the environment; and a pragmatic democracy that will let people take care of each other's feelings."

Civic technology plays a vital role in digital democracy, as it helps bridge the gap between citizens and their governments, fostering greater transparency, responsiveness, and collaboration in addressing societal challenges \cite{zhang2022review}. By utilizing civic technology, democratic processes can become more inclusive and effective, leading to improved public policies and services that reflect the needs and values of all citizens \cite{tseng2022rethinking,zhang2022review}.

The 1922 Citizen Hotline in Taiwan serves as an example of effective civic technology. It allows citizens to share their opinions and concerns, provide feedback on government decision-making, and report issues related to public services. During the COVID-19 pandemic, a child contacted the hotline to complain about receiving a pink mask, feeling embarrassed to wear it due to gender stereotypes. In response, hospitals and government officials announced that they would begin using pink masks, challenging gender stereotypes and promoting social innovation \cite{hamm2021makes}.
...
vTaiwan is an open consultation process launched in 2014 that brings together Taiwanese citizens and government in both online and offline spaces. It aims to foster deliberation and reach a rough consensus on national issues while crafting digital legislation. The initiative provides an interactive environment that engages citizens in shaping the democratic process and addressing existing forms of power through consensus-building \cite{vtaiwan}.

The participatory and deliberative democracy process in vTaiwan is structured around the focus conversation method and consists of four stages. In the first stage, issues are identified, and facts, objectives, and experiences relating to them are collected. The second stage involves gathering participants' feelings and sentiments about these objectives and statements. In the third stage, participants converge on sets of feelings that resonate with everyone and brainstorm ideas on how to address these concerns. Finally, in the fourth stage, a rough consensus is formed around an idea, which is then translated into legalese and signed into law \cite{vtaiwan}.

Throughout the process, each stage transitions to the next only when a rough consensus is achieved, ensuring that the final outcome reflects the collective wisdom of participants in the vTaiwan initiative \cite{vtaiwan}. 
